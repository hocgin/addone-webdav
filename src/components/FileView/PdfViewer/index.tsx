...
export class PDFPage extends React.Component<any, any> {
  canvas: any;
...
export default class PDFDriver extends React.Component<any, any> {
  container: any;
  ...
  componentDidMount() {
    ...
    PDFJS.getDocument(filePath, null, null, this.progressCallback.bind(this)).then((pdf: any) => {
  ...
  renderPages() {
    ...
    if (!pdf) return null;
    const pages = Array.apply(null, {length: pdf?.numPages} as any);
